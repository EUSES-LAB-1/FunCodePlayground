...
def check_webpage(link: str) -> None:
    ...
    visible_elements = driver.find_element,("css selector", "*:not([style*=‘display:none’]):not([style*=‘display: none’])")
...
def check_weather():
    lat = 40.7314
    lon = -73.8656
    forecasts = n.points_forecast(40.7314, -73.8656, type='forecastGridData')
